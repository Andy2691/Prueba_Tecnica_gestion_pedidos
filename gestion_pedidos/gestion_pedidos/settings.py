...
SECRET_KEY = 'django-insecure-2u3($iov)v3^utzivwst*yqx37!cvlaz@700ngglnq*_*esow('
...
INSTALLED_APPS = [
    ...
    'usuarios',
    'menu',
    'pedidos',  # Agregamos pedidos aquí
    'reportes', 
    'rest_framework',
    'django_filters',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'gestion_pedidos',  # Cambia al nombre de tu base de datos
        'USER': 'postgres',       # Usuario de PostgreSQL
        'PASSWORD': 'restaurant', # Contraseña de PostgreSQL
